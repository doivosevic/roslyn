...
#nullable disable
            ...
            BindingDiagnosticBag diagnostics)
        {
            ...
            CompoundUseSiteInfo<AssemblySymbol> useSiteInfo = GetNewCompoundUseSiteInfo(diagnostics);
            this.LookupSymbolsWithFallback(lookupResult1, name, arity: arity, useSiteInfo: ref useSiteInfo, options: options);

            var newOptions = options | LookupOptions.NoImplicitLocals;
            this.LookupSymbolsWithFallback(lookupResult2, name, arity: arity, useSiteInfo: ref useSiteInfo, options: newOptions);
...
#nullable disable
        ...
        private BoundExpression BindImplicitArrayCreationExpression2(ImplicitArrayCreationExpression2Syntax node, BindingDiagnosticBag diagnostics)
        {
        ...
        private ImmutableArray<BoundExpression> BindArrayInitializerExpressions2(InitializerExpression2Syntax initializer, BindingDiagnosticBag diagnostics, int dimension)
        {
        ...
        private void BindArrayInitializerExpressions2(InitializerExpression2Syntax initializer, ArrayBuilder<BoundExpression> exprBuilder, BindingDiagnosticBag diagnostics, int dimension)
        {
